...
export class ProductCategory1755765902108 implements MigrationInterface {
    name = 'ProductCategory1755765902108'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_2f5facebefe0f6257ab3c092a1d" FOREIGN KEY ("categoryTypeId") REFERENCES "category_types"("categoryTypeId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_ff56834e735fa78a15d0cf21926" FOREIGN KEY ("categoryId") REFERENCES "categories"("categoryId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_ee8e92fc3b7ad0fad638d04d73b" FOREIGN KEY ("categoryItemId") REFERENCES "category_items"("categoryItemId") ON DELETE CASCADE ON UPDATE NO ACTION`);
