...
const New = () => {
    ...
    const stateItems = useSelector((state) => state.new.itemsList);
    ...
    const handleSubmit = () => {
        ...
        if (editItem) {
            dispatch(newActions.updateItem(item));
            alert("Item updated!");
        } else {
            dispatch(newActions.addItem(item));
            alert("Item added!");
        }
            ...
            {!showForm ? (
                <Container style={{
                    ...
                    <Row className="mb-4 align-items-center">
                        <Col>
                            <h2 className="text-dark" style={{ fontFamily: 'sans-serif' }}>New Arrival Management</h2>
                        ...
                        <Col className="text-end">
                            ...
                            <Button variant='danger' className="me-2" onClick={() => dispatch(newActions.clearAll())}>Clear All</Button>
                            ...
                            {currentItems.map((item) => (
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        ...
                                        <Button variant="danger" size="sm" onClick={() => dispatch(newActions.removeItem(item.id))}>Remove</Button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                    ...
                    <Row className="justify-content-center">
                        <Col md={10} lg={8}>
                            <Card className="shadow-sm border-0 p-4" style={{ backgroundColor: '#0f1010ff', borderRadius: '8px' }}>
                                <h2 className="mb-4 text-success text-center fw-bold">{editItem ? 'Edit New Arrival Item' : 'Add New Arrival Item'}</h2>
                                <Form>
                                    <Row className="mb-3">
                                        <Col>
